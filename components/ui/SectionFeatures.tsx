...
export default function SectionFeatures() {
  ...
  return (
    <section className="h-[968px] bg-gradient-to-b from-black to-[#450505] pt-[99px]">
      <p className="font-700 mx-auto mb-[25px] w-[218px] text-center text-[40px] leading-[52px]">
